    ...
    public partial class MainWindow : Window
    {
        ...
        private void TimerCounter_Tick(object sender, EventArgs e)
        {
            ...
            if (PublicParamerters.SimulationTime <= Settings.Default.StopSimlationWhen + PublicParamerters.MacStartUp)
            {
                ...
                Title = "M2C:" + PublicParamerters.SimulationTime.ToString();
            }
            else
            {
            ...
            //if (PublicParamerters.NumberOfGenerDataPacket >= 5000)
            {
                StopSimulation();
            }
        ...
        public void RandomDeplayment()
        {
            ...
            //}
            //Ring.setInitialParameters(120, 10, Canvas_SensingFeild);
