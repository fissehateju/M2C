...
namespace RR.ExpermentsResults.Energy_consumptions
{
    ...
    public partial class ExpReport : Window
    {
        ...
        public ExpReport(MainWindow _mianWind)
        {
            ...
            List.Add(new ValParPair() { Par = "# Data Pcket", Val = PublicParamerters.NumberOfGenerDataPacket.ToString() }); ;
            ...
            List.Add(new ValParPair() { Par = "# Diagonal Virtual Line Construction Packet", Val = PublicParamerters.NumberOfRingConstructionPacket.ToString() });
